...
class TravelController extends Controller
{
            ...
            if ($auth_user->hasRole('superadmin') || $auth_user->hasRole('admin') || $auth_user->hasRole('editor')) {
                ...
                foreach($travel as $current_travel)
                {
                    $data[] = [
                        ...
                        'URL' => 'https://api.lesscars.io/travel/' . $current_travel->url_token,
    ...
    public function sendMail(Request $request)
    {
        ...
        \Mail::to($travalContact->email)->from($request->email)->send(new ContactUser($travalContact, $request->email, $request->description));
