...
@section('content')
    ...
    <div class="container">
        ...
        @if (session()->has('message'))
            ...
            <p><a href="https://www.g20-protestwelle.de/anreise/">>>Hier geht’s zur Mitfahrbörse der G20-Protestwelle</a></p>
                ...
                <table class="table table-striped">
                    ...
                    @foreach ($travel as $current_travel)
                        ...
                        <tr class="<?php if ($is_offer) : echo 'offer'; else: echo 'request'; endif; ?>">
                            ...
                            <td><button class="btn-delete-travel mdl-button mdl-js-button mdl-js-ripple-effect mdl-button--raised mdl-button--accent" data-ref-id="{{$current_travel->id}}">löschen</button></td>
